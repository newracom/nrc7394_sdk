...
typedef void *(*mz_alloc_malloc_cb)(void *opaque, size_t size);
typedef void *(*mz_alloc_calloc_cb)(void *opaque, size_t items, size_t size);
typedef void  (*mz_alloc_free_cb)(void *opaque, void *ptr);
