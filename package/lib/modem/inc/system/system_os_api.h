...
typedef enum {
	...
	WAIT_EVENT_TX_ACK_SUCCESS       = BIT(2),
	WAIT_EVENT_TX_ACK_FAILURE       = BIT(3),
	WAIT_EVENT_EAPOL_M4_ACK_SUCCESS = BIT(4),
	WAIT_EVENT_EAPOL_M4_ACK_FAILURE = BIT(5),
...
typedef enum {
	...
	NOTIFY_EVENT_TX_ACK_SUCCESS,
	NOTIFY_EVENT_TX_ACK_FAILURE,
