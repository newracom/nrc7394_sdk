...
//#define ROMLIB_BITOR(a)	(((uint32_t)(&a) & (uint32_t)0x1) == 0x1 )? a : a+1
#define ROMLIB_BITOR(a)	(void *)((uint32_t)a | 0x1)
//======================================================================================================================
// Function Prototypes
//======================================================================================================================
...
#define RegGPIO_DAT				(*((volatile uint32_t *)(GPIO_BASE_ADDR + 0x00)))
#define RegGPIO_DIR				(*((volatile uint32_t *)(GPIO_BASE_ADDR + 0x04)))
#define RegGPIO_ALT0				(*((volatile uint32_t *)(0x40005000 + 0x08)))
#define RegGPIO_ALT1				(*((volatile uint32_t *)(0x40005000 + 0x0c)))
#define RegGPIO_ALT2			(*((volatile uint32_t *)(GPIO_BASE_ADDR + 0x10)))
#define RegGPIO_PULLUP 			(*((volatile uint32_t *)(GPIO_BASE_ADDR + 0x30)))

#define GPIOSET_BASE_ADDR (0x40005400)
#define RegGPIOSET_ALT0				(*((volatile uint32_t *)(GPIOSET_BASE_ADDR + 0x08)))
#define RegGPIOSET_ALT2				(*((volatile uint32_t *)(GPIOSET_BASE_ADDR + 0x10)))

#define GPIOCLR_BASE_ADDR (0x40005200)
#define RegGPIOCLR_ALT0				(*((volatile uint32_t *)(GPIOCLR_BASE_ADDR + 0x08)))
#define RegGPIOCLR_ALT2				(*((volatile uint32_t *)(GPIOCLR_BASE_ADDR + 0x10)))

#define MYIOMUX_BASE_ADDR (0x40005800)
#define RegIOMUX_HSPI0				(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x18)))
#define RegIOMUX_HSPI1				(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x1C)))
#define RegGPIO_EINT00CTL			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x40)))
#define RegGPIO_EINT00STAT			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x44)))
#define RegGPIO_EINT01CTL			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x48)))
#define RegGPIO_EINT01STAT			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x4c)))
#define RegGPIO_EINT02CTL			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x50)))
#define RegGPIO_EINT02STAT			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x54)))
#define RegGPIO_EINT03CTL			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x58)))
#define RegGPIO_EINT03STAT			(*((volatile uint32_t *)(MYIOMUX_BASE_ADDR + 0x5c)))
...
#define EV_TIMER4	    (17)//IRQ1
#define EV_RTC          (18)//IRQ2
#define EV_WDT          (19)//IRQ3
#define EV_TIMER0       (20)//IRQ4
#define EV_HMAC0	    (21)//IRQ5
#define EV_DMACINTTC    (22)//IRQ6
#define EV_TIMER5       (23)//IRQ7
#define EV_TIMER1       (24)//IRQ8
#define EV_HSUART0      (25)//IRQ9
#define EV_SSP0         (26)//IRQ10
#define EV_PWR_FAIL     (27)//IRQ11
#define EV_LPO		    (28)//IRQ12
#define EV_DMACINTERR   (29)//IRQ13
#define EV_RESERVED5    (30)//IRQ14
#define EV_RESERVED6    (31)//IRQ15
#define EV_TIMER2       (32)//IRQ16
#define EV_HSUART1      (33)//IRQ17
#define EV_SSP1         (34)//IRQ18
#define EV_I2C          (35)//IRQ19
#define EV_HMAC1        (36)//IRQ20
#define EV_HMAC2        (37)//IRQ21
#define EV_HMAC3   		(38)//IRQ22
#define EV_RTC_EST   	(39)//IRQ23
#define EV_TIMER3       (40)//IRQ24
#define EV_RESERVED7    (41)//IRQ25
#define EV_RESERVED8 	(42)//IRQ26
#define EV_RESERVED9	(43)//IRQ27
#define EV_EXT0       	(44)//IRQ28
#define EV_EXT1       	(45)//IRQ29
#define EV_TXQUE        (46)//IRQ30
#define EV_RXQUE        (47)//IRQ31
...
#define ARM_SCR  (*((volatile uint32_t *)(0xE000ED10)))
...
#define RegSCFG_CONFIG0				(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x10)))
...
#define RegSCFG_TEST_OUT			(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x20)))
#define RegSCFG_RA_DUMP				(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x24)))
#define RegSCFG_PKG_OPT				(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x28)))
#define RegSCFG_POR_FLAG            (*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x2C)))
#define RegSCFG_REMAP_RST           (*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x30)))
#define RegSCFG_MEMCONFIG           (*((volatile uint32_t *)(SCFG_BASE_ADDR + 0x34)))
#define RegSCFG_VENDERID			(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0xF0)))
#define RegSCFG_CHIPID				(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0xF4)))
#define RegSCFG_REVNR				(*((volatile uint32_t *)(SCFG_BASE_ADDR + 0xF8)))
...
#define SYS_MAX_TX_GAIN_VALUE	50
...
#define RegHIF_DEVICE_HST_STATS		(*((volatile uint32_t *)(HIF_BASE_ADDR + 0x08)))
...
#define RegPMC_PWR_GOOD			(*((volatile uint32_t *)(PMC_BASE_ADDR + 0x3C)))

#define XTAL32K_OK				(BIT16)
...
// LPO CAL
//======================================================================================================================
#define LPO_BASE_ADDR  (0x4004B000)
...
#define RegSFC_CCTRL        (*((volatile uint32_t *)(SFC_BASE_ADDR + 0x100)))
#define RegSFC_STAT         (*((volatile uint32_t *)(SFC_BASE_ADDR + 0x104)))
...
#define CACHE_DISABLED	(0x4)
#define CACHE_ENABLED	(0x2)
...
#define SEC_IP_BASE     (SYSTEM_APB1_BASE + 0x9000)	//0x40049000

#define SIP_REG_SOFT_RSTN         (SEC_IP_BASE + 0x0000)
#define SIP_REG_SOFT_RSTN_SHIFT           1
#define SIP_REG_SOFT_RSTN_MASK            0x00000001
#define SIP_REG_DATA_CFG          (SEC_IP_BASE + 0x0004)
#define SIP_REG_DATA_CFG_IN_CONV          SIP_REG_DATA_CFG
#define SIP_REG_DATA_CFG_IN_CONV_SHIFT    0
#define SIP_REG_DATA_CFG_IN_CONV_MASK     0x00000001
#define SIP_REG_DATA_CFG_OUT_CONV         SIP_REG_DATA_CFG
#define SIP_REG_DATA_CFG_OUT_CONV_SHIFT   1
#define SIP_REG_DATA_CFG_OUT_CONV_MASK    0x00000002
#define SIP_REG_DATA_CFG_MODE             SIP_REG_DATA_CFG
#define SIP_REG_DATA_CFG_MODE_SHIFT       8
#define SIP_REG_DATA_CFG_MODE_MASK        0x00000300
#define SIP_REG_SHA_CFG           (SEC_IP_BASE + 0x0008)
#define SIP_REG_SHA_CFG_MODE              SIP_REG_SHA_CFG
#define SIP_REG_SHA_CFG_MODE_SHIFT        0
#define SIP_REG_SHA_CFG_MODE_MASK         0x00000001
#define SIP_REG_SHA_CFG_2SEL              SIP_REG_SHA_CFG
#define SIP_REG_SHA_CFG_2SEL_SHIFT        1
#define SIP_REG_SHA_CFG_2SEL_MASK         0x00000002
#define SIP_REG_SHA_CFG_2VAR              SIP_REG_SHA_CFG
#define SIP_REG_SHA_CFG_2VAR_SHIFT        2
#define SIP_REG_SHA_CFG_2VAR_MASK         0x00000004
#define SIP_REG_SHA_CFG_1ST_BLK           SIP_REG_SHA_CFG
#define SIP_REG_SHA_CFG_1ST_BLK_SHIFT     3
#define SIP_REG_SHA_CFG_1ST_BLK_MASK      0x00000008
#define SIP_REG_SHA_START         (SEC_IP_BASE + 0x000C)
#define SIP_REG_SHA_START_SHIFT           0
#define SIP_REG_SHA_START_MASK            0x00000001
#define SIP_REG_AES_CFG           (SEC_IP_BASE + 0x0010)
#define SIP_REG_AES_CFG_MODE              SIP_REG_AES_CFG
#define SIP_REG_AES_CFG_MODE_SHIFT        0
#define SIP_REG_AES_CFG_MODE_MASK         0x00000003
#define SIP_REG_AES_CFG_FORWARD           SIP_REG_AES_CFG
#define SIP_REG_AES_CFG_FORWARD_SHIFT     8
#define SIP_REG_AES_CFG_FORWARD_MASK      0x00000100
#define SIP_REG_AES_START         (SEC_IP_BASE + 0x0014)
#define SIP_REG_AES_START_SHIFT           0
#define SIP_REG_AES_START_MASK            0x00000001
#define SIP_REG_DES_CFG           (SEC_IP_BASE + 0x0018)
#define SIP_REG_DES_CFG_MODE              SIP_REG_DES_CFG
#define SIP_REG_DES_CFG_MODE_SHIFT        0
#define SIP_REG_DES_CFG_MODE_MASK         0x00000001
#define SIP_REG_DES_CFG_LEN               SIP_REG_DES_CFG
#define SIP_REG_DES_CFG_LEN_SHIFT         16
#define SIP_REG_DES_CFG_LEN_MASK          0xFFFF0000
#define SIP_REG_DES_START_REQ      (SEC_IP_BASE + 0x001C)
#define SIP_REG_DES_START                 SIP_REG_DES_START_REQ
#define SIP_REG_DES_START_SHIFT           0
#define SIP_REG_DES_START_MASK            0x00000001
#define SIP_REG_DES_REQ                   SIP_REG_DES_START_REQ
#define SIP_REG_DES_REQ_SHIFT             1
#define SIP_REG_DES_REQ_MASK              0x00000002
#define SIP_REG_BIGNUM_CFG        (SEC_IP_BASE + 0x0020)
#define SIP_REG_BIGNUM_CFG_MODE              SIP_REG_BIGNUM_CFG
#define SIP_REG_BIGNUM_CFG_MODE_SHIFT        0
#define SIP_REG_BIGNUM_CFG_MODE_MASK         0x0000000F
#define SIP_REG_BIGNUM_START_ABORT    (SEC_IP_BASE + 0x0024)
#define SIP_REG_BIGNUM_START                 SIP_REG_BIGNUM_START_ABORT
#define SIP_REG_BIGNUM_START_SHIFT           0
#define SIP_REG_BIGNUM_START_MASK            0x00000001
#define SIP_REG_BIGNUM_ABORT                 SIP_REG_BIGNUM_START_ABORT
#define SIP_REG_BIGNUM_ABORT_SHIFT           1
#define SIP_REG_BIGNUM_ABORT_MASK            0x00000002
#define SIP_REG_BIGNUM_OP_CLEAR       (SEC_IP_BASE + 0x0028)
#define SIP_REG_BIGNUM_CLR_OPA               SIP_REG_BIGNUM_OP_CLEAR
#define SIP_REG_BIGNUM_CLR_OPA_SHIFT         0
#define SIP_REG_BIGNUM_CLR_OPA_MASK           0x00000001
#define SIP_REG_BIGNUM_CLR_OPB               SIP_REG_BIGNUM_OP_CLEAR
#define SIP_REG_BIGNUM_CLR_OPB_SHIFT         1
#define SIP_REG_BIGNUM_CLR_OPB_MASK          0x00000002
#define SIP_REG_BIGNUM_CLR_OPN               SIP_REG_BIGNUM_OP_CLEAR
#define SIP_REG_BIGNUM_CLR_OPN_SHIFT         2
#define SIP_REG_BIGNUM_CLR_OPN_MASK          0x00000004
#define SIP_REG_MON_00            (SEC_IP_BASE + 0x0040)
#define SIP_REG_MON_SHA_DONE              SIP_REG_MON_00
#define SIP_REG_MON_SHA_DONE_SHIFT        0
#define SIP_REG_MON_SHA_DONE_MASK         0x00000001
#define SIP_REG_MON_SHA_BUSY              SIP_REG_MON_00
#define SIP_REG_MON_SHA_BUSY_SHIFT        1
#define SIP_REG_MON_SHA_BUSY_MASK         0x00000002
#define SIP_REG_MON_01            (SEC_IP_BASE + 0x0044)
#define SIP_REG_MON_AES_DONE              SIP_REG_MON_01
#define SIP_REG_MON_AES_DONE_SHIFT        0
#define SIP_REG_MON_AES_DONE_MASK         0x00000001
#define SIP_REG_MON_AES_BUSY              SIP_REG_MON_01
#define SIP_REG_MON_AES_BUSY_SHIFT        1
#define SIP_REG_MON_AES_BUSY_MASK         0x00000002
#define SIP_REG_MON_02            (SEC_IP_BASE + 0x0048)
#define SIP_REG_MON_DES_DONE              SIP_REG_MON_02
#define SIP_REG_MON_DES_DONE_SHIFT        0
#define SIP_REG_MON_DES_DONE_MASK         0x00000001
#define SIP_REG_MON_DES_BUSY              SIP_REG_MON_02
#define SIP_REG_MON_DES_BUSY_SHIFT        1
#define SIP_REG_MON_DES_BUSY_MASK         0x00000002
#define SIP_REG_MON_03            (SEC_IP_BASE + 0x004C)
#define SIP_REG_MON_BIGNUM_DONE           SIP_REG_MON_03
#define SIP_REG_MON_BIGNUM_DONE_SHIFT     0
#define SIP_REG_MON_BIGNUM_DONE_MASK      0x00000001
#define SIP_REG_MON_BIGNUM_BUSY           SIP_REG_MON_03
#define SIP_REG_MON_BIGNUM_BUSY_SHIFT     1
#define SIP_REG_MON_BIGNUM_BUSY_MASK      0x00000002
#define SIP_REG_MON_BIGNUM_ERR            SIP_REG_MON_03
#define SIP_REG_MON_BIGNUM_ERR_SHIFT      2
#define SIP_REG_MON_BIGNUM_ERR_MASK       0x00000004
#define SIP_REG_INTR_MASK         (SEC_IP_BASE + 0x0080)
#define SIP_REG_INTR_MASK_SHIFT           0
#define SIP_REG_INTR_MASK_MASK            0x0000FFFF
#define SIP_REG_INTR_CLEAR        (SEC_IP_BASE + 0x0084)
#define SIP_REG_INTR_CLEAR_SHIFT          0
#define SIP_REG_INTR_CLEAR_MASK           0x0000FFFF
#define SIP_REG_INTR_STATUS       (SEC_IP_BASE + 0x0088)
#define SIP_REG_INTR_STATUS_SHIFT         0
#define SIP_REG_INTR_STATUS_MASK          0x0000FFFF
#define SIP_REG_VERSION_INFO      (SEC_IP_BASE + 0x01FC)
#define SIP_REG_VERSION_INFO_SHIFT        0
#define SIP_REG_VERSION_INFO_MASK         0x000000FF
#define SIP_REG_IN_MSG            (SEC_IP_BASE + 0x0200)
#define SIP_REG_IN_KEY            (SEC_IP_BASE + 0x0240)
#define SIP_REG_DES_IV            (SEC_IP_BASE + 0x0240)
#define SIP_REG_DES_KEY1          (SEC_IP_BASE + 0x0248)
#define SIP_REG_DES_KEY2          (SEC_IP_BASE + 0x0250)
#define SIP_REG_DES_KEY3          (SEC_IP_BASE + 0x0258)
#define SIP_REG_IN_MOD            (SEC_IP_BASE + 0x0280)
#define SIP_REG_OUT_MSG  	      (SEC_IP_BASE + 0x0300)
