#ifndef __HAL_GPIO_NRC7392_H__
#define __HAL_GPIO_NRC7392_H__
...
typedef struct {
	...
	volatile gpio_io_t alt2;			//10
	volatile gpio_io_t alt3;			//14
	volatile gpio_io_t alt4;			//18
	...
	volatile uint32_t reserved6;		//58
	volatile uint32_t reserved7;		//5c
	volatile uint32_t reserved8;		//60
	volatile uint32_t reserved9;		//64
	volatile uint32_t reserved10;		//68
...
void nrc_gpio_set_alt2(gpio_io_t *gpio);
void nrc_gpio_get_alt2(gpio_io_t *gpio);
void nrc_gpio_set_alt3(gpio_io_t *gpio);
void nrc_gpio_get_alt3(gpio_io_t *gpio);
void nrc_gpio_set_alt4(gpio_io_t *gpio);
void nrc_gpio_get_alt4(gpio_io_t *gpio);
