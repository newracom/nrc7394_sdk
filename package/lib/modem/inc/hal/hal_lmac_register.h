...
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [21:16]    SEARCH_FIELD_TIMEOUT          R/W  default = 20
...
---------------------------------------------------------------------------------
   ...
   [   15]    RX_ALL_BEACON                 R/W  default = 0

   [   13]    RX_MY_PS_POLL                 R/W  default = 0
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    COMPR_BSSID                   R/W  default = 0
               -Compression BSSID for SBR (output of CRC32 with BSSID)
...
---------------------------------------------------------------------------------
   - This register describes which control frame to send as a response frame when frame is received
   - Received BAR Frame : Send BA by BAR
   [   31]    RSP21_VALID                   R/W  default = 1

   [30:26]    RSP21_CASE                    R/W  default = 7
   ...
   [20:17]    RSP21_MASK_RX_PV0_SUBTYPE     R/W  default = 15
   ...
   [ 9: 8]    RSP21_RX_PV0_TYPE             R/W  default = 1
                 0 : MANAGEMENT
                 1 : CONTROL
                 2 : DATA

   [ 7: 4]    RSP21_RX_PV0_SUBTYPE          R/W  default = 8

   [    3]    RSP21_RX_PV                   R/W  default = 0
   ...
   [    0]    RSP21_RX_INFO_AGG             R/W  default = 0
...
---------------------------------------------------------------------------------
   ...
   - CF_TYPE_NDPBA                : 11
   - CF_TYPE_PV1_STACK            : 12
   - CF_TYPE_PV1_BAT              : 13
   - CF_TYPE_BA solicited by BAR  : 14
   - CF_TYPE_NDPBA solicited by BAR: 15
   - CF_TYPE_PV1_BAT solicited by BAR: 16
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   - Response Case 7 : Send BA by BAR
   - CF_TYPE_NONE : 0
   - CF_TYPE_CTS  : 2
   - CF_TYPE_ACK  : 3
   - CF_TYPE_BA   : 4
   ...
   - CF_TYPE_NDPBA solicited by BAR: 15
   - CF_TYPE_PV1_BAT solicited by BAR: 16
   [   31]    CASE7_IRQ_NO                  R/W  default = 0

   [28:24]    CASE7_CF_TYPE_NO              R/W  default = 0

   [   23]    CASE7_IRQ_NDP                 R/W  default = 0

   [20:16]    CASE7_CF_TYPE_NDP             R/W  default = 15

   [   15]    CASE7_IRQ_NORMAL              R/W  default = 0

   [12: 8]    CASE7_CF_TYPE_NORMAL          R/W  default = 14

   [    7]    CASE7_IRQ_LONG                R/W  default = 0

   [ 4: 0]    CASE7_CF_TYPE_LONG            R/W  default = 0
...
---------------------------------------------------------------------------------
    Address  : 0x40080244
    Name     : SET_CONTROL_FRAME
    Bit      : 2
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [    1]    ACK_BA_POWER_MANAGEMENT       R/W  default = 0
               -If the value is 1, Power Management bit in Ack and BlockAck is set to 1. Otherwise, the bit is set to 0.

   [    0]    FIX_MOREDATA                  R/W  default = 0
...
---------------------------------------------------------------------------------
   ...
   [27:24]    SEC_BIP_INPUT_INTERVAL        R/W  default = 5


---------------------------------------------------------------------------------
    Address  : 0x40080384
    Name     : SEC_OFFLINE_ENC_START_ADDR
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    SEC_OFFLINE_ENC_START_ADDR    R/W  default = 0
               -Start address of encryption in offline mode


---------------------------------------------------------------------------------
    Address  : 0x40080388
    Name     : SEC_OFFLINE_DEC_START_DESC
    Bit      : 5
    R/W      : R/W
---------------------------------------------------------------------------------
   [ 4: 0]    SEC_OFFLINE_DEC_START_DESC    R/W  default = 0
               -Start descriptor of decrytion in offline mode


---------------------------------------------------------------------------------
    Address  : 0x4008038c
    Name     : SEC_OFFLINE_REQUEST
    Bit      : 2
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [    1]    SEC_OFFLINE_REQUEST_ENC       R/W  default = 0

   [    0]    SEC_OFFLINE_REQUEST_DEC       R/W  default = 0
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [24:20]    READ_OFFSET_ENCRYPT_3         R/W  default = 0
               -Not used

   [19:15]    READ_OFFSET_ENCRYPT_2         R/W  default = 9
               -The length between the start of MAC header and the start of MAC payload

   [14:10]    READ_OFFSET_DECRYPT           R/W  default = 9
               -The length of rx buffer header

   [ 9: 5]    READ_OFFSET_ENCRYPT_1         R/W  default = 3
               -The length of TxVector

   [ 4: 0]    READ_OFFSET_ENCRYPT_0         R/W  default = 9
               -The length of BufferDescriptor
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [    0]    BUS_CLK_MODE                  R/W  default = 0
               -BUS CLOCK MODE for memory arbitration
                 0 : 32MHz
                 1 : 16MHz
...
---------------------------------------------------------------------------------
    Address  : 0x40080800
    Name     : TX_RF_PARAM_LOWER_0
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_0           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_0
               -   : BIT[ 9: 0] - TXLO_PARA_Q
...
---------------------------------------------------------------------------------
    Address  : 0x40080804
    Name     : TX_RF_PARAM_MIDDLE_0
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_0          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_0
               -   : BIT[ 9: 0] - TXIQ_PARA_0[10:1]
               -   : BIT[20:10] - TXIQ_PARA_3
               -   : BIT[31:21] - TXIQ_PARA_2


---------------------------------------------------------------------------------
    Address  : 0x40080808
    Name     : TX_RF_PARAM_UPPER_0
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_0           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_0
               -   : BIT[ 9: 0] - TXIQ_PARA_5
               -   : BIT[20:10] - TXIQ_PARA_4
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_0                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_0
               -   : BIT[15:0] - TX_DIGITAL_GAIN


---------------------------------------------------------------------------------
    Address  : 0x40080810
    Name     : TX_ANAGAIN_DPD_0
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_0                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_0
               -   : BIT[3:0] - TLTF Gain
               -   : BIT[6:4] - TMX Gain
               -   : BIT[9:7] - PA Gain

   [ 7: 0]    DPD_INDEX_0                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_0
               -   : BIT[1:0] - BB Full Range Sel.
               -   : BIT[3:2] - BB LUT Set Sel.
               -   : BIT[5:4] - RF Full Range Sel.
               -   : BIT[7:6] - RF LUT Set Sel.


---------------------------------------------------------------------------------
    Address  : 0x40080814
    Name     : TX_RF_PARAM_LOWER_1
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_1           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_1


---------------------------------------------------------------------------------
    Address  : 0x40080818
    Name     : TX_RF_PARAM_MIDDLE_1
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_1          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_1


---------------------------------------------------------------------------------
    Address  : 0x4008081c
    Name     : TX_RF_PARAM_UPPER_1
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_1           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_1
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_1                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_1


---------------------------------------------------------------------------------
    Address  : 0x40080824
    Name     : TX_ANAGAIN_DPD_1
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_1                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_1

   [ 7: 0]    DPD_INDEX_1                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_1


---------------------------------------------------------------------------------
    Address  : 0x40080828
    Name     : TX_RF_PARAM_LOWER_2
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_2           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_2


---------------------------------------------------------------------------------
    Address  : 0x4008082c
    Name     : TX_RF_PARAM_MIDDLE_2
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_2          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_2


---------------------------------------------------------------------------------
    Address  : 0x40080830
    Name     : TX_RF_PARAM_UPPER_2
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_2           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_2
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_2                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_2


---------------------------------------------------------------------------------
    Address  : 0x40080838
    Name     : TX_ANAGAIN_DPD_2
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_2                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_2

   [ 7: 0]    DPD_INDEX_2                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_2


---------------------------------------------------------------------------------
    Address  : 0x4008083c
    Name     : TX_RF_PARAM_LOWER_3
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_3           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_3


---------------------------------------------------------------------------------
    Address  : 0x40080840
    Name     : TX_RF_PARAM_MIDDLE_3
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_3          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_3


---------------------------------------------------------------------------------
    Address  : 0x40080844
    Name     : TX_RF_PARAM_UPPER_3
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_3           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_3
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_3                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_3


---------------------------------------------------------------------------------
    Address  : 0x4008084c
    Name     : TX_ANAGAIN_DPD_3
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_3                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_3

   [ 7: 0]    DPD_INDEX_3                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_3


---------------------------------------------------------------------------------
    Address  : 0x40080850
    Name     : TX_RF_PARAM_LOWER_4
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_4           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_4


---------------------------------------------------------------------------------
    Address  : 0x40080854
    Name     : TX_RF_PARAM_MIDDLE_4
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_4          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_4


---------------------------------------------------------------------------------
    Address  : 0x40080858
    Name     : TX_RF_PARAM_UPPER_4
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_4           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_4
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_4                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_4


---------------------------------------------------------------------------------
    Address  : 0x40080860
    Name     : TX_ANAGAIN_DPD_4
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_4                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_4

   [ 7: 0]    DPD_INDEX_4                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_4


---------------------------------------------------------------------------------
    Address  : 0x40080864
    Name     : TX_RF_PARAM_LOWER_5
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_5           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_5


---------------------------------------------------------------------------------
    Address  : 0x40080868
    Name     : TX_RF_PARAM_MIDDLE_5
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_5          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_5


---------------------------------------------------------------------------------
    Address  : 0x4008086c
    Name     : TX_RF_PARAM_UPPER_5
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_5           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_5
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_5                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_5


---------------------------------------------------------------------------------
    Address  : 0x40080874
    Name     : TX_ANAGAIN_DPD_5
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_5                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_5

   [ 7: 0]    DPD_INDEX_5                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_5


---------------------------------------------------------------------------------
    Address  : 0x40080878
    Name     : TX_RF_PARAM_LOWER_6
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_6           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_6


---------------------------------------------------------------------------------
    Address  : 0x4008087c
    Name     : TX_RF_PARAM_MIDDLE_6
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_6          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_6


---------------------------------------------------------------------------------
    Address  : 0x40080880
    Name     : TX_RF_PARAM_UPPER_6
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_6           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_6
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_6                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_6


---------------------------------------------------------------------------------
    Address  : 0x40080888
    Name     : TX_ANAGAIN_DPD_6
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_6                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_6

   [ 7: 0]    DPD_INDEX_6                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_6


---------------------------------------------------------------------------------
    Address  : 0x4008088c
    Name     : TX_RF_PARAM_LOWER_7
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_7           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_7


---------------------------------------------------------------------------------
    Address  : 0x40080890
    Name     : TX_RF_PARAM_MIDDLE_7
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_7          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_7


---------------------------------------------------------------------------------
    Address  : 0x40080894
    Name     : TX_RF_PARAM_UPPER_7
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_7           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_7
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_7                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_7


---------------------------------------------------------------------------------
    Address  : 0x4008089c
    Name     : TX_ANAGAIN_DPD_7
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_7                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_7

   [ 7: 0]    DPD_INDEX_7                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_7


---------------------------------------------------------------------------------
    Address  : 0x400808a0
    Name     : TX_RF_PARAM_LOWER_8
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_8           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_8


---------------------------------------------------------------------------------
    Address  : 0x400808a4
    Name     : TX_RF_PARAM_MIDDLE_8
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_8          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_8


---------------------------------------------------------------------------------
    Address  : 0x400808a8
    Name     : TX_RF_PARAM_UPPER_8
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_8           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_8
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_8                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_8


---------------------------------------------------------------------------------
    Address  : 0x400808b0
    Name     : TX_ANAGAIN_DPD_8
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_8                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_8

   [ 7: 0]    DPD_INDEX_8                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_8


---------------------------------------------------------------------------------
    Address  : 0x400808b4
    Name     : TX_RF_PARAM_LOWER_9
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_9           R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_9


---------------------------------------------------------------------------------
    Address  : 0x400808b8
    Name     : TX_RF_PARAM_MIDDLE_9
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_9          R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_9


---------------------------------------------------------------------------------
    Address  : 0x400808bc
    Name     : TX_RF_PARAM_UPPER_9
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_9           R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_9
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_9                 R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_9


---------------------------------------------------------------------------------
    Address  : 0x400808c4
    Name     : TX_ANAGAIN_DPD_9
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_9                  R/W  default = 0
               -TX Analog Gain for TX_COMMAND_9

   [ 7: 0]    DPD_INDEX_9                   R/W  default = 0
               -DPD LUT index for TX_COMMAND_9


---------------------------------------------------------------------------------
    Address  : 0x400808c8
    Name     : TX_RF_PARAM_LOWER_10
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_10          R/W  default = 0
               -TX RF PARAM lower 32bit for TX_COMMAND_10


---------------------------------------------------------------------------------
    Address  : 0x400808cc
    Name     : TX_RF_PARAM_MIDDLE_10
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_10         R/W  default = 0
               -TX RF PARAM middle 32bit for TX_COMMAND_10


---------------------------------------------------------------------------------
    Address  : 0x400808d0
    Name     : TX_RF_PARAM_UPPER_10
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_10          R/W  default = 0
               -TX RF PARAM upper 22bit for TX_COMMAND_10
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_10                R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_10


---------------------------------------------------------------------------------
    Address  : 0x400808d8
    Name     : TX_ANAGAIN_DPD_10
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_10                 R/W  default = 0
               -TX Analog Gain for TX_COMMAND_10

   [ 7: 0]    DPD_INDEX_10                  R/W  default = 0
               -DPD LUT index for TX_COMMAND_10


---------------------------------------------------------------------------------
    Address  : 0x400808dc
    Name     : TX_RF_PARAM_LOWER_CF
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_LOWER_CF          R/W  default = 0
               -TX RF PARAM lower 32bit for Control Frame


---------------------------------------------------------------------------------
    Address  : 0x400808e0
    Name     : TX_RF_PARAM_MIDDLE_CF
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   [31: 0]    TX_RF_PARAM_MIDDLE_CF         R/W  default = 0
               -TX RF PARAM middle 32bit for Control Frame


---------------------------------------------------------------------------------
    Address  : 0x400808e4
    Name     : TX_RF_PARAM_UPPER_CF
    Bit      : 22
    R/W      : R/W
---------------------------------------------------------------------------------
   [21: 0]    TX_RF_PARAM_UPPER_CF          R/W  default = 0
               -TX RF PARAM upper 22bit for Control Frame
...
---------------------------------------------------------------------------------
    ...
    R/W      : R/W
---------------------------------------------------------------------------------
   [15: 0]    TX_DIG_GAIN_CF                R/W  default = 0
               -TX DIGITAL GAIN 16bit for TX_COMMAND_0


---------------------------------------------------------------------------------
    Address  : 0x400808ec
    Name     : TX_ANAGAIN_DPD_CF
    Bit      : 32
    R/W      : R/W
---------------------------------------------------------------------------------
   + separate
---------------------------------------------------------------------------------
   [25:16]    TX_ANAGAIN_CF                 R/W  default = 0
               -TX Analog Gain for Control Frame

   [ 7: 0]    DPD_INDEX_CF                  R/W  default = 0
               -DPD LUT index for Control Frame
...
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_STA_FILTER_MODE_RX_ALL_BEACON                                 = MAC_REG_STA_FILTER_MODE,
          MAC_REG_STA_FILTER_MODE_RX_ALL_BEACON_SHIFT                           = 15,
          MAC_REG_STA_FILTER_MODE_RX_ALL_BEACON_MASK                            = 0x00008000,
          MAC_REG_STA_FILTER_MODE_RX_MY_PS_POLL                                 = MAC_REG_STA_FILTER_MODE,
          MAC_REG_STA_FILTER_MODE_RX_MY_PS_POLL_SHIFT                           = 13,
          MAC_REG_STA_FILTER_MODE_RX_MY_PS_POLL_MASK                            = 0x00002000,
...
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_COMPR_BSSID                                                         = 0x400800b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_DMA_BURST                                                           = 0x400800b8,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_DMA_READ_FIFO_ADJUST                                                = 0x400800bc,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_CONCURRENT_CONFIG_BITMAP                                            = 0x400800c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_CONTROL_PARAMETER                                                = 0x400800c4,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_CASE7                                                           = 0x40080164,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NO                                        = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NO_SHIFT                                  = 31,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NO_MASK                                   = 0x80000000,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NO                                    = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NO_SHIFT                              = 24,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NO_MASK                               = 0x1f000000,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NDP                                       = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NDP_SHIFT                                 = 23,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NDP_MASK                                  = 0x00800000,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NDP                                   = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NDP_SHIFT                             = 16,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NDP_MASK                              = 0x001f0000,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NORMAL                                    = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NORMAL_SHIFT                              = 15,
          MAC_REG_RSP_CASE7_CASE7_IRQ_NORMAL_MASK                               = 0x00008000,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NORMAL                                = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NORMAL_SHIFT                          = 8,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_NORMAL_MASK                           = 0x00001f00,
          MAC_REG_RSP_CASE7_CASE7_IRQ_LONG                                      = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_IRQ_LONG_SHIFT                                = 7,
          MAC_REG_RSP_CASE7_CASE7_IRQ_LONG_MASK                                 = 0x00000080,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_LONG                                  = MAC_REG_RSP_CASE7,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_LONG_SHIFT                            = 0,
          MAC_REG_RSP_CASE7_CASE7_CF_TYPE_LONG_MASK                             = 0x0000001f,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_CASE8                                                           = 0x40080168,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_CASE9                                                           = 0x4008016c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_CASE10                                                          = 0x40080170,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_CASE11                                                          = 0x40080174,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_WAIT_MODE_WR                                                        = 0x40080178,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_WAIT_MODE_RD                                                        = 0x4008017c,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_0                                                        = 0x40080180,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_1                                                        = 0x40080184,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_2                                                        = 0x40080188,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_3                                                        = 0x4008018c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_4                                                        = 0x40080190,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_5                                                        = 0x40080194,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_6                                                        = 0x40080198,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_7                                                        = 0x4008019c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_8                                                        = 0x400801a0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_9                                                        = 0x400801a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_COMMAND_10                                                       = 0x400801a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_0                                                      = 0x400801ac,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_1                                                      = 0x400801b0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_2                                                      = 0x400801b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_3                                                      = 0x400801b8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_4                                                      = 0x400801bc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_5                                                      = 0x400801c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_6                                                      = 0x400801c4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_7                                                      = 0x400801c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_8                                                      = 0x400801cc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_9                                                      = 0x400801d0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXOP_COMMAND_10                                                     = 0x400801d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_0                                                       = 0x400801d8,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_1                                                       = 0x400801dc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_2                                                       = 0x400801e0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_3                                                       = 0x400801e4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_4                                                       = 0x400801e8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RAW_EDCA_5                                                       = 0x400801ec,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_BASE_ADDRESS                                                     = 0x400801f0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSW_DATA_IN_WAIT                                                    = 0x400801f4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_COMMAND                                                 = 0x400801f8,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_START_TSF                                               = 0x400801fc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_END_TSF                                                 = 0x40080200,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_DURATION                                                = 0x40080204,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_MYRAW_START_TSF                                                  = 0x40080208,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_MYRAW_END_TSF                                                    = 0x4008020c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_MYRAW_DURATION                                                   = 0x40080210,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_SETTING                                                 = 0x40080214,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_SUPPRESS_STATUS                                                  = 0x40080218,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DATA_IN_WAIT                                                     = 0x4008021c,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_PHY_TXFIFO_MAX_DEPTH                                                = 0x40080220,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXNAV_VALUE                                                         = 0x40080224,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXNAV_VALUE                                                         = 0x40080228,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RID_VALUE                                                           = 0x4008022c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_NAV_RESET                                                           = 0x40080230,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RID_RESET                                                           = 0x40080234,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_NAV_RID_CONTROL_MODE                                                = 0x40080238,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TXNAV_HW_SETTING_VALUE                                              = 0x4008023c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_PREAMBLE_TYPE                                                       = 0x40080240,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_CONTROL_FRAME                                                   = 0x40080244,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_SET_CONTROL_FRAME_ACK_BA_POWER_MANAGEMENT                     = MAC_REG_SET_CONTROL_FRAME,
          MAC_REG_SET_CONTROL_FRAME_ACK_BA_POWER_MANAGEMENT_SHIFT               = 1,
          MAC_REG_SET_CONTROL_FRAME_ACK_BA_POWER_MANAGEMENT_MASK                = 0x00000002,
          MAC_REG_SET_CONTROL_FRAME_FIX_MOREDATA                                = MAC_REG_SET_CONTROL_FRAME,
          MAC_REG_SET_CONTROL_FRAME_FIX_MOREDATA_SHIFT                          = 0,
          MAC_REG_SET_CONTROL_FRAME_FIX_MOREDATA_MASK                           = 0x00000001,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_PS_POLL_ACK_SW                                                  = 0x40080248,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_PS_POLL_ACK_DEFAULT                                             = 0x4008024c,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_RTSRID                                                          = 0x40080250,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_CF_CHANNEL_WIDTH_SELECTION                                          = 0x40080254,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_FLOW_CONTROL_INFO_0                                             = 0x40080258,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_FLOW_CONTROL_INFO_1                                             = 0x4008025c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_ACK_SW                                                          = 0x40080260,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_ACK_DEFAULT                                                     = 0x40080264,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_BASIC_RATE_BITMAP                                                   = 0x40080268,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_BASIC_RATE_BITMAP_2ND                                               = 0x4008026c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_MCS_DIFFERENCE                                                      = 0x40080270,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RESPONSE_TX_COMMAND                                                 = 0x40080274,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_VECTOR                                                       = 0x40080278,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_SIG0                                                         = 0x4008027c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_SIG1                                                         = 0x40080280,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_INFO0                                                        = 0x40080284,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_INFO1                                                        = 0x40080288,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA0                                                        = 0x4008028c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA1                                                        = 0x40080290,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA2                                                        = 0x40080294,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA3                                                        = 0x40080298,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA4                                                        = 0x4008029c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA5                                                        = 0x400802a0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA6                                                        = 0x400802a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA7                                                        = 0x400802a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA8                                                        = 0x400802ac,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA9                                                        = 0x400802b0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RSP_TX_DATA10                                                       = 0x400802b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_CF_TXVECTOR_SIG                                                 = 0x400802b8,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_MONITOR_INTERVAL                                                    = 0x400802bc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_CCA_RANGE_VAR_SET0                                                  = 0x400802c0,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_CCA_RANGE_VAR_SET1                                                  = 0x400802c4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_BASE_ADDRESS                                                     = 0x400802c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_DSC_NUM                                                          = 0x400802cc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC0                                                     = 0x400802d0,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC1                                                     = 0x400802d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC2                                                     = 0x400802d8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC3                                                     = 0x400802dc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC4                                                     = 0x400802e0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC5                                                     = 0x400802e4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC6                                                     = 0x400802e8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC7                                                     = 0x400802ec,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC8                                                     = 0x400802f0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC9                                                     = 0x400802f4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC10                                                    = 0x400802f8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC11                                                    = 0x400802fc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC12                                                    = 0x40080300,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC13                                                    = 0x40080304,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC14                                                    = 0x40080308,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC15                                                    = 0x4008030c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC16                                                    = 0x40080310,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC17                                                    = 0x40080314,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC18                                                    = 0x40080318,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC19                                                    = 0x4008031c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC20                                                    = 0x40080320,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC21                                                    = 0x40080324,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC22                                                    = 0x40080328,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC23                                                    = 0x4008032c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC24                                                    = 0x40080330,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC25                                                    = 0x40080334,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC26                                                    = 0x40080338,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC27                                                    = 0x4008033c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC28                                                    = 0x40080340,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC29                                                    = 0x40080344,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC30                                                    = 0x40080348,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_REG_DL_DESC31                                                    = 0x4008034c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SET_OWNER_ADDR                                                      = 0x40080350,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_DATA_IN_WAIT                                                     = 0x40080354,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_DMA_SEG_THRESHOLD                                                   = 0x40080358,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_CMD                                                         = 0x4008035c,
//-------------------------------------------------------------------------------------------------------------------------------,
          ...
          MAC_REG_SEC_KEY_CMD_SEC_KEY_CMD_KEY_ID_MASK                                       = 0x07000000,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_CMD_EN                                                      = 0x40080360,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_VALUE0                                                      = 0x40080364,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_VALUE1                                                      = 0x40080368,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_VALUE2                                                      = 0x4008036c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_VALUE3                                                      = 0x40080370,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_STA_ADDRESS_0                                                    = 0x40080374,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_STA_ADDRESS_1                                                    = 0x40080378,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_CCMP_UPDATE_INFO                                                = 0x4008037c,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
          ...
          MAC_REG_SEC_CONFIG_SEC_BIP_INPUT_INTERVAL                             = MAC_REG_SEC_CONFIG,
          MAC_REG_SEC_CONFIG_SEC_BIP_INPUT_INTERVAL_SHIFT                       = 24,
          MAC_REG_SEC_CONFIG_SEC_BIP_INPUT_INTERVAL_MASK                        = 0x0f000000,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_OFFLINE_ENC_START_ADDR                                          = 0x40080384,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_OFFLINE_DEC_START_DESC                                          = 0x40080388,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_OFFLINE_REQUEST                                                 = 0x4008038c,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_ENC                   = MAC_REG_SEC_OFFLINE_REQUEST,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_ENC_SHIFT             = 1,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_ENC_MASK              = 0x00000002,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_DEC                   = MAC_REG_SEC_OFFLINE_REQUEST,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_DEC_SHIFT             = 0,
          MAC_REG_SEC_OFFLINE_REQUEST_SEC_OFFLINE_REQUEST_DEC_MASK              = 0x00000001,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INFO_1                                                          = 0x40080390,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INFO_2                                                          = 0x40080394,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INFO_3                                                          = 0x40080398,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INFO_4                                                          = 0x4008039c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_OFFSET                                                          = 0x400803a0,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_3                              = MAC_REG_SEC_OFFSET,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_3_SHIFT                        = 20,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_3_MASK                         = 0x01f00000,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_2                              = MAC_REG_SEC_OFFSET,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_2_SHIFT                        = 15,
          MAC_REG_SEC_OFFSET_READ_OFFSET_ENCRYPT_2_MASK                         = 0x000f8000,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_DATA_IN_WAIT_CNT                                                = 0x400803a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_FLAG_IDX                                                    = 0x400803a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_INDIR_REG_ADDR                                                   = 0x400803ac,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_INDIR_REG_ADDR                                                   = 0x400803b0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INDIR_REG_ADDR                                                  = 0x400803b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_DMA_INDIR_REG_ADDR                                                  = 0x400803b8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_INDIR_REG_ADDR                                                  = 0x400803bc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_MEM_INDIR_REG_ADDR                                                  = 0x400803c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_0_LOWER                                                         = 0x400803c4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_0_UPPER                                                         = 0x400803c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_0_ALARM_LOWER                                                   = 0x400803cc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_BCN_INTERVAL_0                                                      = 0x400803d0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TBTT_INTERRUPT_MARGIN_0                                             = 0x400803d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TBTT_RESTART_RANGE_0                                                = 0x400803d8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_1_LOWER                                                         = 0x400803dc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_1_UPPER                                                         = 0x400803e0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_1_ALARM_LOWER                                                   = 0x400803e4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_BCN_INTERVAL_1                                                      = 0x400803e8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TBTT_INTERRUPT_MARGIN_1                                             = 0x400803ec,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TBTT_RESTART_RANGE_1                                                = 0x400803f0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_MASK0                                                           = 0x400803f4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_MASK1                                                           = 0x400803f8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_SET_CLEAR0                                                      = 0x400803fc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_SET_CLEAR1                                                      = 0x40080400,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_CLOCK_GATING_CONFIG                                                 = 0x40080404,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_0                                                         = 0x40080408,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_1                                                         = 0x4008040c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_2                                                         = 0x40080410,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_3                                                         = 0x40080414,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_4                                                         = 0x40080418,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_5                                                         = 0x4008041c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_6                                                         = 0x40080420,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_7                                                         = 0x40080424,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_8                                                         = 0x40080428,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_9                                                         = 0x4008042c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_10                                                        = 0x40080430,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_11                                                        = 0x40080434,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_12                                                        = 0x40080438,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_13                                                        = 0x4008043c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_14                                                        = 0x40080440,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_15                                                        = 0x40080444,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_16                                                        = 0x40080448,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_17                                                        = 0x4008044c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_18                                                        = 0x40080450,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_19                                                        = 0x40080454,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_20                                                        = 0x40080458,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RESULT_21                                                        = 0x4008045c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_0                                            = 0x40080460,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_0                                            = 0x40080464,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_1                                            = 0x40080468,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_1                                            = 0x4008046c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_2                                            = 0x40080470,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_2                                            = 0x40080474,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_3                                            = 0x40080478,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_3                                            = 0x4008047c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_4                                            = 0x40080480,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_4                                            = 0x40080484,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_5                                            = 0x40080488,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_5                                            = 0x4008048c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_6                                            = 0x40080490,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_6                                            = 0x40080494,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_7                                            = 0x40080498,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_7                                            = 0x4008049c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_8                                            = 0x400804a0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_8                                            = 0x400804a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_9                                            = 0x400804a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_9                                            = 0x400804ac,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_LOWER_10                                           = 0x400804b0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_FAILED_BITMAP_UPPER_10                                           = 0x400804b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RESPONSE_TX_RESULT                                                  = 0x400804b8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC0                                                = 0x400804bc,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC1                                                = 0x400804c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC2                                                = 0x400804c4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC3                                                = 0x400804c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC4                                                = 0x400804cc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC5                                                = 0x400804d0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC6                                                = 0x400804d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC7                                                = 0x400804d8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC8                                                = 0x400804dc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC9                                                = 0x400804e0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC10                                               = 0x400804e4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC11                                               = 0x400804e8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC12                                               = 0x400804ec,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC13                                               = 0x400804f0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC14                                               = 0x400804f4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC15                                               = 0x400804f8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC16                                               = 0x400804fc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC17                                               = 0x40080500,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC18                                               = 0x40080504,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC19                                               = 0x40080508,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC20                                               = 0x4008050c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC21                                               = 0x40080510,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC22                                               = 0x40080514,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC23                                               = 0x40080518,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC24                                               = 0x4008051c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC25                                               = 0x40080520,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC26                                               = 0x40080524,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC27                                               = 0x40080528,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC28                                               = 0x4008052c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC29                                               = 0x40080530,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC30                                               = 0x40080534,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_WRITE_EN_DL_DESC31                                               = 0x40080538,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXSIG0                                                              = 0x4008053c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXSIG1                                                              = 0x40080540,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXVECTOR0                                                           = 0x40080544,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXVECTOR1                                                           = 0x40080548,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXVECTOR2                                                           = 0x4008054c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXINFO0                                                             = 0x40080550,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXINFO1                                                             = 0x40080554,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXINFO2                                                             = 0x40080558,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXINFO3                                                             = 0x4008055c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER0                                                           = 0x40080560,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER1                                                           = 0x40080564,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER2                                                           = 0x40080568,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER3                                                           = 0x4008056c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER4                                                           = 0x40080570,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER5                                                           = 0x40080574,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER6                                                           = 0x40080578,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER7                                                           = 0x4008057c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RXHEADER8                                                           = 0x40080580,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_AMPDU_BITMAP                                                        = 0x40080584,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_KEY_CMD_RESULT_EN                                                   = 0x40080588,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_KEY_CMD_RESULT                                                      = 0x4008058c,
//-------------------------------------------------------------------------------------------------------------------------------,
          ...
          MAC_REG_KEY_CMD_RESULT_ADDRESS_MASK                                   = 0x00003fff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_REG_MIC_CHECK_FAIL                                              = 0x40080590,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_KEY_FLAG                                                        = 0x40080594,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_MIC_VALUE_RX_FAILED_0                                           = 0x40080598,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_MIC_VALUE_RX_FAILED_1                                           = 0x4008059c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_INDIR_REG_DATA                                                   = 0x400805a0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_INDIR_REG_DATA                                                   = 0x400805a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_SEC_INDIR_REG_DATA                                                  = 0x400805a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_DMA_INDIR_REG_DATA                                                  = 0x400805ac,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_INDIR_REG_DATA                                                  = 0x400805b0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_0_LOWER_READONLY                                                = 0x400805b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_0_UPPER_READONLY                                                = 0x400805b8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_1_LOWER_READONLY                                                = 0x400805bc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TSF_1_UPPER_READONLY                                                = 0x400805c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_SRC_NOCLEAR0                                                    = 0x400805c4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_SRC_NOCLEAR1                                                    = 0x400805c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_IRQ_SRC0                                                            = 0x400805cc,
//-------------------------------------------------------------------------------------------------------------------------------,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_RX_NDP_PAGING                                                       = 0x400805d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_BUS_CLK_MODE                                                        = 0x40080700,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_0                                                 = 0x40080800,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_0                                                = 0x40080804,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_0                                                 = 0x40080808,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_0                                                       = 0x4008080c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_0                                                    = 0x40080810,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_0_TX_ANAGAIN_0                                 = MAC_REG_TX_ANAGAIN_DPD_0,
          MAC_REG_TX_ANAGAIN_DPD_0_TX_ANAGAIN_0_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_0_TX_ANAGAIN_0_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_0_DPD_INDEX_0                                  = MAC_REG_TX_ANAGAIN_DPD_0,
          MAC_REG_TX_ANAGAIN_DPD_0_DPD_INDEX_0_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_0_DPD_INDEX_0_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_1                                                 = 0x40080814,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_1                                                = 0x40080818,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_1                                                 = 0x4008081c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_1                                                       = 0x40080820,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_1                                                    = 0x40080824,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_1_TX_ANAGAIN_1                                 = MAC_REG_TX_ANAGAIN_DPD_1,
          MAC_REG_TX_ANAGAIN_DPD_1_TX_ANAGAIN_1_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_1_TX_ANAGAIN_1_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_1_DPD_INDEX_1                                  = MAC_REG_TX_ANAGAIN_DPD_1,
          MAC_REG_TX_ANAGAIN_DPD_1_DPD_INDEX_1_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_1_DPD_INDEX_1_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_2                                                 = 0x40080828,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_2                                                = 0x4008082c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_2                                                 = 0x40080830,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_2                                                       = 0x40080834,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_2                                                    = 0x40080838,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_2_TX_ANAGAIN_2                                 = MAC_REG_TX_ANAGAIN_DPD_2,
          MAC_REG_TX_ANAGAIN_DPD_2_TX_ANAGAIN_2_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_2_TX_ANAGAIN_2_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_2_DPD_INDEX_2                                  = MAC_REG_TX_ANAGAIN_DPD_2,
          MAC_REG_TX_ANAGAIN_DPD_2_DPD_INDEX_2_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_2_DPD_INDEX_2_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_3                                                 = 0x4008083c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_3                                                = 0x40080840,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_3                                                 = 0x40080844,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_3                                                       = 0x40080848,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_3                                                    = 0x4008084c,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_3_TX_ANAGAIN_3                                 = MAC_REG_TX_ANAGAIN_DPD_3,
          MAC_REG_TX_ANAGAIN_DPD_3_TX_ANAGAIN_3_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_3_TX_ANAGAIN_3_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_3_DPD_INDEX_3                                  = MAC_REG_TX_ANAGAIN_DPD_3,
          MAC_REG_TX_ANAGAIN_DPD_3_DPD_INDEX_3_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_3_DPD_INDEX_3_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_4                                                 = 0x40080850,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_4                                                = 0x40080854,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_4                                                 = 0x40080858,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_4                                                       = 0x4008085c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_4                                                    = 0x40080860,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_4_TX_ANAGAIN_4                                 = MAC_REG_TX_ANAGAIN_DPD_4,
          MAC_REG_TX_ANAGAIN_DPD_4_TX_ANAGAIN_4_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_4_TX_ANAGAIN_4_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_4_DPD_INDEX_4                                  = MAC_REG_TX_ANAGAIN_DPD_4,
          MAC_REG_TX_ANAGAIN_DPD_4_DPD_INDEX_4_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_4_DPD_INDEX_4_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_5                                                 = 0x40080864,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_5                                                = 0x40080868,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_5                                                 = 0x4008086c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_5                                                       = 0x40080870,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_5                                                    = 0x40080874,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_5_TX_ANAGAIN_5                                 = MAC_REG_TX_ANAGAIN_DPD_5,
          MAC_REG_TX_ANAGAIN_DPD_5_TX_ANAGAIN_5_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_5_TX_ANAGAIN_5_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_5_DPD_INDEX_5                                  = MAC_REG_TX_ANAGAIN_DPD_5,
          MAC_REG_TX_ANAGAIN_DPD_5_DPD_INDEX_5_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_5_DPD_INDEX_5_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_6                                                 = 0x40080878,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_6                                                = 0x4008087c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_6                                                 = 0x40080880,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_6                                                       = 0x40080884,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_6                                                    = 0x40080888,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_6_TX_ANAGAIN_6                                 = MAC_REG_TX_ANAGAIN_DPD_6,
          MAC_REG_TX_ANAGAIN_DPD_6_TX_ANAGAIN_6_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_6_TX_ANAGAIN_6_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_6_DPD_INDEX_6                                  = MAC_REG_TX_ANAGAIN_DPD_6,
          MAC_REG_TX_ANAGAIN_DPD_6_DPD_INDEX_6_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_6_DPD_INDEX_6_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_7                                                 = 0x4008088c,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_7                                                = 0x40080890,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_7                                                 = 0x40080894,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_7                                                       = 0x40080898,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_7                                                    = 0x4008089c,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_7_TX_ANAGAIN_7                                 = MAC_REG_TX_ANAGAIN_DPD_7,
          MAC_REG_TX_ANAGAIN_DPD_7_TX_ANAGAIN_7_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_7_TX_ANAGAIN_7_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_7_DPD_INDEX_7                                  = MAC_REG_TX_ANAGAIN_DPD_7,
          MAC_REG_TX_ANAGAIN_DPD_7_DPD_INDEX_7_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_7_DPD_INDEX_7_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_8                                                 = 0x400808a0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_8                                                = 0x400808a4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_8                                                 = 0x400808a8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_8                                                       = 0x400808ac,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_8                                                    = 0x400808b0,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_8_TX_ANAGAIN_8                                 = MAC_REG_TX_ANAGAIN_DPD_8,
          MAC_REG_TX_ANAGAIN_DPD_8_TX_ANAGAIN_8_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_8_TX_ANAGAIN_8_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_8_DPD_INDEX_8                                  = MAC_REG_TX_ANAGAIN_DPD_8,
          MAC_REG_TX_ANAGAIN_DPD_8_DPD_INDEX_8_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_8_DPD_INDEX_8_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_9                                                 = 0x400808b4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_9                                                = 0x400808b8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_9                                                 = 0x400808bc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_9                                                       = 0x400808c0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_9                                                    = 0x400808c4,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_9_TX_ANAGAIN_9                                 = MAC_REG_TX_ANAGAIN_DPD_9,
          MAC_REG_TX_ANAGAIN_DPD_9_TX_ANAGAIN_9_SHIFT                           = 16,
          MAC_REG_TX_ANAGAIN_DPD_9_TX_ANAGAIN_9_MASK                            = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_9_DPD_INDEX_9                                  = MAC_REG_TX_ANAGAIN_DPD_9,
          MAC_REG_TX_ANAGAIN_DPD_9_DPD_INDEX_9_SHIFT                            = 0,
          MAC_REG_TX_ANAGAIN_DPD_9_DPD_INDEX_9_MASK                             = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_10                                                = 0x400808c8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_10                                               = 0x400808cc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_10                                                = 0x400808d0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_10                                                      = 0x400808d4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_10                                                   = 0x400808d8,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_10_TX_ANAGAIN_10                               = MAC_REG_TX_ANAGAIN_DPD_10,
          MAC_REG_TX_ANAGAIN_DPD_10_TX_ANAGAIN_10_SHIFT                         = 16,
          MAC_REG_TX_ANAGAIN_DPD_10_TX_ANAGAIN_10_MASK                          = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_10_DPD_INDEX_10                                = MAC_REG_TX_ANAGAIN_DPD_10,
          MAC_REG_TX_ANAGAIN_DPD_10_DPD_INDEX_10_SHIFT                          = 0,
          MAC_REG_TX_ANAGAIN_DPD_10_DPD_INDEX_10_MASK                           = 0x000000ff,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_LOWER_CF                                                = 0x400808dc,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_MIDDLE_CF                                               = 0x400808e0,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_RF_PARAM_UPPER_CF                                                = 0x400808e4,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_DIG_GAIN_CF                                                      = 0x400808e8,
//-------------------------------------------------------------------------------------------------------------------------------,
//-------------------------------------------------------------------------------------------------------------------------------,
    MAC_REG_TX_ANAGAIN_DPD_CF                                                   = 0x400808ec,
//-------------------------------------------------------------------------------------------------------------------------------,
          MAC_REG_TX_ANAGAIN_DPD_CF_TX_ANAGAIN_CF                               = MAC_REG_TX_ANAGAIN_DPD_CF,
          MAC_REG_TX_ANAGAIN_DPD_CF_TX_ANAGAIN_CF_SHIFT                         = 16,
          MAC_REG_TX_ANAGAIN_DPD_CF_TX_ANAGAIN_CF_MASK                          = 0x03ff0000,
          MAC_REG_TX_ANAGAIN_DPD_CF_DPD_INDEX_CF                                = MAC_REG_TX_ANAGAIN_DPD_CF,
          MAC_REG_TX_ANAGAIN_DPD_CF_DPD_INDEX_CF_SHIFT                          = 0,
          MAC_REG_TX_ANAGAIN_DPD_CF_DPD_INDEX_CF_MASK                           = 0x000000ff
};
