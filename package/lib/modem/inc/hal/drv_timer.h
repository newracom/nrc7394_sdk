#ifndef __HAL_TIMER_NRC7394_H__
#define __HAL_TIMER_NRC7394_H__

#include "system_common.h"
#include "hal_timer.h"

#define NRC7394_TIMER_CH_NUM 4
#define NRC7394_TIMER_32_BITS 32
#define NRC7394_TIMER_64_BITS 64
#define NRC7394_TIMER_IS_VALID(ch, bit, ret)								\
do {																		\
...
struct tmr_ops *nrc_timer_7394_ops();
...
void nrc_timer64_set_target(int channel_index, UINT64 target);
#else
