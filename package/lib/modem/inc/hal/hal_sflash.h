#ifndef __HAL_SFLASH_NRC7394_H__
...
bool nrc_sf_update_module_feature(uint32_t feature);
uint32_t nrc_sf_get_max_txgain(void);
bool nrc_sf_update_max_txgain(uint32_t txgain);
uint32_t nrc_sf_get_max_txpwr(void);
bool nrc_sf_update_max_txpwr(uint32_t txpwr);
bool nrc_sf_update_rssi_ref_info(uint32_t ref_info);
uint32_t nrc_sf_get_rssi_ref_info(void);
bool nrc_sf_update_cfo_dcxo_cal(uint8_t cfo_dcxo);
uint8_t nrc_sf_get_cfo_dcxo_cal(void);
bool nrc_sf_update_cfo_valid(bool cfo_valid);
...
#endif //__HAL_SFLASH_NRC7394_H__
