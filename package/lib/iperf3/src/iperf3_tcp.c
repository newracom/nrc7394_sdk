 ...
 */
int
iperf3_tcp_recv(struct iperf3_stream *sp)
{
    int r;
 ...
 */
int
iperf3_tcp_send(struct iperf3_stream *sp)
{
    int r;
 ...
 */
int
iperf3_tcp_accept(struct iperf3_test * test)
{
    int     s;
 ...
 */
int
iperf3_tcp_listen(struct iperf3_test *test)
{
 ...
 */
int
iperf3_tcp_connect(struct iperf3_test *test)
{
