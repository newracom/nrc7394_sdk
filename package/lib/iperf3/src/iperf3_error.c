...
void
iperf3_err(struct iperf3_test *test, const char *format, ...)
{
    va_list argp;
    char str[1000];
...
void
iperf3_errexit(struct iperf3_test *test, const char *format, ...)
{
    va_list argp;
    char str[1000];
