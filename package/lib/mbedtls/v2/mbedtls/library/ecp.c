...
#if defined( INCLUDE_HW_SECURITY_ACC_BN )  || defined(INCLUDE_HW_SECURITY_ACC_SHA)
#include "drv_sec.h"
#endif
...
//HW operation is slower then SW operation (because of compare and memory allocation)
//HW Disable
