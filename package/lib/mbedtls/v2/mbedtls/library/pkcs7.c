                                      ...
                                      size_t *len)
{
    ...
    if (ret != 0) {
        ...
        ret = MBEDTLS_ERR_PKCS7_INVALID_CONTENT_INFO + MBEDTLS_ERR_ASN1_LENGTH_MISMATCH;
    }
...
out:
    if (asn1_ret != 0 || ret != 0) {
        ...
        ret = MBEDTLS_ERR_PKCS7_INVALID_SIGNER_INFO + asn1_ret;
    }
                                 ...
                                 mbedtls_pkcs7_signed_data *signed_data)
{
    ...
    if (p + len != end) {
        return MBEDTLS_ERR_PKCS7_INVALID_FORMAT + MBEDTLS_ERR_ASN1_LENGTH_MISMATCH;
    }
                            ...
                            const size_t buflen)
{
    ...
    if ((size_t) (end - p) != len) {
        ret = MBEDTLS_ERR_PKCS7_INVALID_FORMAT + MBEDTLS_ERR_ASN1_LENGTH_MISMATCH;
        goto out;
    }
