...
{
    return mbedtls_mpi_shift_l_hw(X, count);
}
...
{
    return mbedtls_mpi_shift_r_hw(X, count);
}
...
{
    return mbedtls_mpi_add_abs_hw(X, A, B);
}

int mbedtls_mpi_add_abs_sw(mbedtls_mpi *X, const mbedtls_mpi *A, const mbedtls_mpi *B)
#else
int mbedtls_mpi_add_abs(mbedtls_mpi *X, const mbedtls_mpi *A, const mbedtls_mpi *B)
...
{
    return mbedtls_mpi_sub_abs_hw(X, A, B);
}

int mbedtls_mpi_sub_abs_sw(mbedtls_mpi *X, const mbedtls_mpi *A, const mbedtls_mpi *B)
#else
int mbedtls_mpi_sub_abs(mbedtls_mpi *X, const mbedtls_mpi *A, const mbedtls_mpi *B)
...
{
    return mbedtls_mpi_mod_mpi_hw(R, A, B);
}
