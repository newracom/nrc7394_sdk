...
extern int crypto_ec_point_solve_y_coord(struct crypto_ec *e,
				     ...
				     const struct crypto_bignum *u)
{
	...
	uint8_t buf[32] = {0xff,0xff,0xff,0xff,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
