...
#define MAX_MESSAGE_HANDLERS 15 /* redefinable - how many subscriptions do you want? */
#endif
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribeWithResults(MQTTClient* client, const char* topicFilter, int qos, messageHandler, MQTTSubackData* data);
